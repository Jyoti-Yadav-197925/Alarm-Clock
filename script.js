...
const setAlarmBtn = document.querySelector("#btn-alarmsetting");
let alarmCount = 0;
let alarmTime;
let ring = new Audio("ringtone/rain_drops.mp3");
...
//Set Alarm section......
///these loops are for alarm to set...........
...
function setAlarm(){
    document.querySelector("#heading").innerText = "Alarms";
    ...
    if(time.includes("hour") || time.includes("min") || time.includes("am-pm")){
        ...
        alarmCount++;
        document.querySelector(".Listingalarm").innerHTML += `
        <div class="alarmLog" id="clock${alarmCount}">
...
function deleteAlarm(click_id){
    var element = document.getElementById("clock"+click_id);
